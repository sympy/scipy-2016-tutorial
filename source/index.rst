...
core modules may require additional expertise. More information can
be found in SymPy's `documentation <http://docs.sympy.org>`_ and on
`wiki <http://wiki.sympy.org>`_ pages.
